...
function isValidCase(obj: any): boolean {
  ...
  if (!Array.isArray(obj.suspects) || obj.suspects.length < 4) return false;
  if (!Array.isArray(obj.clues) || obj.clues.length < 5) return false;
